# Openfeature .NET Provider for Harness Feature Flags

This repository contains all the details that'll help you to develop OpenFeature 
.NET provider for Harness Feature Flags! 

# Openfeature .Net Client for Harness Feature Flags

This repository contains all the details that'll help you to develop OpenFeature .NET client for Harness Feature Flags! 
